...
export const PRESS_QUESTIONS = [
  // ── Major events ──────────────────────────────────────────────────────────
  {
    id: 'after_exam_win',
    trigger: 'exam_win',
    question: 'Your squad just won the Adept Exam. What does this mean for the village going forward?',
  ...
  },
  {
    ...
    intro: 'A senior scribe from the Five Warden archive requests an audience.',
...
export const TONE_TRIGGER_OVERRIDES = {
  ...
  'callout:rivalry_heat': { repBonus: 12, moraleBonus: 5,  note: 'The public rally behind the Warden. Rival rel craters.' },
