...
export const FNAMES=['Ryu','Sora','Hana','Kei','Taro','Mei','Ren','Yuki','Kaz','Aoi','Jin','Aya','Nao','Riku','Hiro','Shiro','Toma','Rei','Sai','Bunta','Akira','Haru','Kaito','Rin','Daichi','Yui','Sho','Emi','Kenta','Nozomi','Takeru','Sana','Ryo','Kaede','Isamu','Chika','Goro','Miki','Tatsu','Yuna','Kenji','Asuka','Makoto','Hikaru','Noboru','Saya','Osamu','Kimi','Tetsu','Ami','Kohaku','Rai','Mio','Souta','Ume','Kazuki','Nori','Ayame','Jun','Suzu','Kane','Tomo','Reiji','Hoshi','Kuro','Ginji','Yori','Michi','Sen','Kira','Tora','Hayate','Natsu','Koji','Ran','Seiji','Fuyu','Daigo','Miu','Renta','Kai','Yozora','Shinji','Arata','Momo','Ryoma','Kanna','Taku','Ena','Sayo','Genta','Mana','Riko']
export const LNAMES=['Kuroda','Nishida','Asano','Takahara','Minase','Hayashi','Mori','Fujita','Ito','Nakamura','Tanaka','Watanabe','Sato','Kagawa','Shimizu','Morioka','Tachibana','Hoshino','Kirigaya','Yamazaki','Onodera','Sakaguchi','Fukui','Amano','Kuroki','Ishikawa','Nagase','Terada','Okabe','Serizawa','Kanzaki','Mizuno','Kurosawa','Aizawa','Hattori','Kobayashi','Tsukahara','Yoshida','Ueda','Enomoto','Shinozaki','Nakagawa','Okamoto','Hasegawa','Fujimoto','Ryuzaki','Sasaki','Iwata','Kimura','Maeda','Narita','Ogawa','Saeki','Toriyama','Uchida','Wakabayashi','Yano','Akiyama','Doi','Ebihara']
export const SPECS=['Ninjutsu','Taijutsu','Genjutsu','Medical','Sensor','Shadow Ops','Sealing','Infiltration']
// ── Per-shinobi generation flavor (chakra nature, mannerism, aspiration) ───────
export const ELEMENTS=['Fire','Water','Wind','Earth','Lightning']
export const QUIRKS=['Never removes their mask','Hums an old tune mid-fight','Presses flowers between mission reports','Refuses to sit with their back to a door','Sketches everyone they meet','Speaks only when it matters','Always an hour early','Tallies missions in ink on their forearm','Distrusts anyone who smiles too easily','Names every kunai they own','Meditates at dawn without fail','A terrible cook who insists on cooking','Quotes their late sensei constantly','Cannot sleep indoors','Compulsively tidies the barracks','Laughs at the worst moments','Never breaks eye contact first','Feeds every stray cat in the village','Writes letters they never send','Counts their steps under their breath','Superstitious about even numbers','Talks quietly to their reflection','Keeps a fallen friend\'s headband','Sharpens blades that are already sharp','Collects rumors like currency','Trains barefoot in any weather']
export const DREAMS=['To become Warden one day','To restore their clan\'s honor','To never lose another comrade','To see the world beyond the borders','To surpass their old sensei','To retire quietly and open a teahouse','To find the sibling who vanished','To be remembered in the chronicles','To protect the next generation','To master a forbidden technique','To prove a civilian-born can be a legend','To end the cycle of village wars','To earn an estranged family\'s respect','To die a hero, not in a bed','To build a life outside the shinobi world','To avenge a mentor\'s death','To lead a squad of their own','To simply live long enough to matter']
...
export const JUTSU_LIST=[
  ...
  {id:'fireball',     n:'Grand Flame Surge',          tier:'common',  statKey:'ninjutsu',     clan:'Kageha',    req:{winsB:10}, bonus:{powerMod:0.05},                desc:'The Kageha\'s signature. A roaring sphere of fire.'},
  {id:'gentle',       n:'Pressure Point Style',       tier:'common',  statKey:'taijutsu',     clan:'Shiromi',   req:{winsB:10}, bonus:{powerMod:0.05},                desc:'Precise strikes target the chakra network directly.'},
  {id:'shadow',       n:'Shadow Snare Jutsu',         tier:'common',  statKey:'intelligence', clan:'Kagero',    req:{winsB:10}, bonus:{successMod:0.04},              desc:'A shadow that cannot be escaped.'},
  {id:'expansion',    n:'Body Expansion Technique',   tier:'common',  statKey:'taijutsu',     clan:'Tsuchida',  req:{winsB:10}, bonus:{powerMod:0.06},                desc:'The body itself becomes the weapon.'},
  ...
  {id:'chidori',      n:'Lightning Blade',            tier:'uncommon',statKey:'speed',        clan:null,        req:{winsS:1},  bonus:{powerMod:0.10},                desc:'A thousand chirping birds. One precise point.'},
