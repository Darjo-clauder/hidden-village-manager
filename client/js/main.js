...
import { rKa, resKE, sGift, propAl, proposePact, answerPact, rattle, sabotageRival, resNCV, setCoachingPhilosophy, payRivalDemand, refuseRivalDemand, demandTribute, appease } from './panels/kage.js'
...
Object.assign(window, {
  ...
  watchLastBattle, toggleAutoWatch, skipBattleViewer, closeBattleViewer, chooseBattleCall, bvTogglePause, bvCycleSpeed, replayBattle, bvSetTactic, bvToggleSettings, bvSetPref, watchArchivedMatch, bvSetOverlay,
  // upgrades
  ...
  // kage
  resKE, sGift, propAl, proposePact, answerPact, rattle, sabotageRival, resNCV, setCoachingPhilosophy,
  ...
  // scouting
  assignScout, setScoutBudget, setBudgetPriority, toggleWatchlist, trialDay, signProspect, draftSort, scoutCtx, scoutHover, toggleScoutDossier, scoSelect, scoFacet,
