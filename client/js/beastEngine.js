...
export const BEAST_DATA = {
  Sakeru: {
    ...
    lore: [
      ...
      { stage: 2, title: 'The Cursed Vessel', body: 'Every Sakeru jinchuriki in recorded history suffered sleep deprivation and paranoia. The beast feeds on fear and cultivates it deliberately within its host.' },
      { stage: 3, title: 'The Desert\'s Heartbeat', body: 'Sakeru was not always feared. Before the era of jinchuriki, nomads left offerings at sand formations shaped like tanuki. They called it the sand\'s heartbeat.' },
  ...
  Niryuu: {
    ...
    flavors: ['Niryuu\'s moods shift like flame — warm and playful one week, wild and dangerous the next.','The Two-Tails shows no malice. Just enormous energy with no off switch.','Niryuu once spent three days aggressively purring at its host. Nobody knows why.'],
    syncCeiling: 5,
    captureMonths: 4,
    statBonus: [
      {},
    ...
    lore: [
      ...
      { stage: 3, title: 'The Playful Nature', body: 'Three jinchuriki from different eras described the same phenomenon: Niryuu playing. Not in the dangerous sense — in the cat sense. Pouncing at things. Missing on purpose. Apparently finding this very funny.' },
      { stage: 4, title: 'Moods and Meaning', body: 'Scholars mapped Niryuu\'s mood cycles and found a pattern. Three weeks of calm, followed by one week of unpredictability. The underlying cause remains unknown. The Two-Tails will not say.' },
  ...
  Tairyuu: {
    ...
    flavors: ['Tairyuu retreats from every approach. Patience is the only language it understands.','The Three-Tails has seen too many jinchuriki. It simply waits for this one to break too.','Tairyuu does not hate. It has given up expecting anything different.'],
    ...
    lore: [
      { stage: 1, title: 'The Sleeping Giant', body: 'For most of recorded history, Tairyuu slept beneath a lake. No one bothered it. It bothered no one. The decision to seal it was purely political — a show of power that the Three-Tails found entirely pointless.' },
      ...
      { stage: 3, title: 'The Pattern of Loss', body: 'Tairyuu has been sealed and lost more times than any other bijuu. Each time, it retreats further into itself. Scholars estimate it has stopped expecting permanence entirely.' },
      { stage: 4, title: 'A Strange Negotiation', body: 'The only successful Tairyuu host on record described their relationship as "formal." Respectful distance. No intimacy, no warmth. But reliability — the Three-Tails always shows up when it matters. It simply refuses to explain itself.' },
      { stage: 5, title: 'The Unreachable Shore', body: 'No confirmed Stage 5 account exists for Tairyuu. The closest: "I think it likes me. I think it will never say so. I have stopped asking." This is accepted as the deepest possible bond with the Three-Tails.' },
    ],
  },
  ...
  'Kaenkou': {
    ...
    flavors: ['Kaenkou will not be owned. It will be respected, or it will fight.','The Four-Tails treats every interaction as a negotiation of honor. Lose respect once and earn back twice.','Kaenkou once refused to lend its power for two months because its host didn\'t say please.'],
    syncCeiling: 5,
    captureMonths: 6,
    statBonus: [
      {},
    ...
    lore: [
      { stage: 1, title: 'The Monkey King\'s Name', body: 'Kaenkou named itself. This matters to it enormously. Every host who failed to use its name — addressing it only as "beast" or "bijuu" — found cooperation dropped to zero within weeks.' },
      { stage: 2, title: 'The Code of the Four-Tails', body: 'Kaenkou operates by rules it will not fully explain. It will share power freely with someone it deems honorable. Strip that honor away — by lying, by cruelty, by weakness — and it withdraws entirely.' },
      { stage: 3, title: 'An Ancient Grudge', body: 'Kaenkou harbors specific hatred for anyone who speaks of bijuu as weapons. This appears to be a matter of profound personal offense. Hosts who agreed were punished. Those who asked why were answered — once, briefly, with "because we are not."' },
      { stage: 4, title: 'What Respect Looks Like', body: 'The most successful Kaenkou host described a daily practice: formal greeting, formal dismissal. Not performance — the Four-Tails can tell. Genuine acknowledgement. "I see you. You are not a tool." That\'s all it wanted.' },
      { stage: 5, title: 'Ally', body: 'Kaenkou called its best-known host "friend." Once. The host described spending the rest of their life trying to deserve that word. Apparently they succeeded. The Four-Tails attended their funeral. In full form. The village was fine.' },
    ],
  },
  ...
  Hasoku: {
    ...
    flavors: ['Hasoku is patient in the way ancient things are patient — it has simply lived through too much to rush.','The Five-Tails observes more than it speaks. When it does speak, it tends to be right.','Hasoku once solved a food shortage crisis through sealed-chakra dream-advice. Its host was confused but grateful.'],
    syncCeiling: 5,
    captureMonths: 6,
    statBonus: [
      {},
    ...
    lore: [
      { stage: 1, title: 'The Gentle Giant', body: 'Hasoku\'s power records are dominated not by destruction but by endurance. It outlasted every other entity in three separate conflicts by simply refusing to stop. It is not the most dramatic bijuu. It is the last one standing.' },
      { stage: 2, title: 'The Five-Tails Speaks', body: 'Unlike other bijuu, Hasoku communicates openly from early in the sealing relationship. Its advice is calm, measured, and frequently several weeks ahead of its usefulness. Only in retrospect does the host realize how right it was.' },
      ...
      { stage: 4, title: 'The Steam That Heals', body: 'Hasoku\'s steam affinity has a regenerative component not fully understood by sealing scholars. Hosts universally report faster recovery from injury. Village medical staff near Hasoku jinchuriki note anomalously low mortality rates.' },
  ...
  Suiro: {
    ...
    flavors: ['Suiro thinks the sealing is an adventure. It is the only bijuu ever described as enthusiastic about the process.','The Six-Tails greets every morning with visible delight. Its host finds this exhausting and also kind of nice.','Suiro once spent an entire month narrating its host\'s dreams. Nobody asked it to. It was very cheerful about this.'],
    syncCeiling: 5,
    ...
    lore: [
      { stage: 1, title: 'The Cooperative Slug', body: 'Suiro is the only bijuu that has cooperated with its own sealing. Twice. The sealing masters involved described the experience as "unexpectedly easy" and then felt vaguely unsettled by that for years afterward.' },
  ...
  Hanaku: {
    ...
    lore: [
      ...
      { stage: 5, title: 'Against All Odds', body: 'Hanaku full sync hosts have the best survival rates of any bijuu on record. Statisticians cannot explain this. Hanaku, when pressed, just vibrated its wings. This is believed to mean "I told you so."' },
    ],
  },
  ...
  Hachitsuno: {
    ...
    flavors: ['Hachitsuno does not trust easily. It trusts completely. There is no middle state.','The Eight-Tails is a creature of absolute loyalty once the bond forms — and absolute silence before.','Hachitsuno once wrestled its host for three weeks before acknowledging them. It was testing, not refusing.'],
    syncCeiling: 5,
    ...
    uniqueAbility: { stage: 4, desc: 'Hachitsuno\'s Ink — jinchuriki can produce chakra constructs that persist for one month (treat as a deployed ally).' },
    ...
    lore: [
      { stage: 1, title: 'The Ox-Octopus', body: 'Hachitsuno\'s form — enormous, eight-tailed, with the horns of an ox and the tentacles of an octopus — has generated more academic debate than any other bijuu. Hachitsuno finds this debate boring and has said so.' },
      ...
      { stage: 5, title: 'The Perfect Team', body: 'A full Hachitsuno sync is the closest thing to a true partnership between bijuu and human that any record describes. Both parties describe it the same way. Hachitsuno\'s version, recorded once: "Finally."' },
    ],
  },
  ...
  Kureni: {
    ...
    flavors: ['Kureni has decided you are worth hating. This is, technically, a compliment — it has ignored lesser hosts entirely.','The Nine-Tails does not negotiate. It condemns, resists, and waits. It has infinite patience for waiting.','Kureni called its host "tolerable" once. The host wept. This was, apparently, the highest praise available.'],
    syncCeiling: 5,
    ...
    lore: [
      { stage: 1, title: 'The Nine-Tails\' Fury', body: 'Kureni\'s attack on the Hidden Village in recorded history was not an accident and not mindless rage. It was Kureni being used as a weapon and being furious about it. The fury has never fully subsided.' },
      { stage: 2, title: 'A Prison It Did Not Choose', body: 'Kureni has been sealed more than any other bijuu. It views this as an ongoing injustice. It is not wrong. Every new host inherits the weight of that history.' },
      { stage: 3, title: 'What Kureni Wants', body: 'After centuries of conflict and scholarship, researchers converged on a single answer to the question of what the Nine-Tails actually wants: to be acknowledged as what it is, rather than feared for what it could do. This is either profound or obvious, depending on who you ask.' },
...
export function tickBeast(beast, G) {
  ...
  if (beast.n === 'Niryuu' && Math.random() < (data.moodSwingChance || 0)) {
    if (Math.random() < 0.5) {
      ...
      events.push({ title: 'Niryuu Warmth', body: `${jinchuriki.fn} ${jinchuriki.ln} reported Niryuu in an especially cooperative mood. Training felt effortless. The entire squad came back glowing.`, type: 'good' })
    } else {
      G.morale = Math.max(0, G.morale - 6)
      events.push({ title: 'Niryuu Mood Swing', body: `${jinchuriki.fn} ${jinchuriki.ln} had to abort a training session when Niryuu became unpredictable. No injuries. But the gym is on fire.`, type: 'warn' })
    }
  }
  ...
  if (beast.n === 'Kureni') {
    ...
    if (data.loyaltyRisk && newStage <= 3 && Math.random() < 0.15) {
      events.push({
        ...
        body: `Kureni pushed against the seal with unusual force — not trying to escape, but testing. ${jinchuriki.fn} ${jinchuriki.ln} held. Barely.`,
        type: 'warn',
      })
    }
  }
  ...
  if (beast.n === 'Kaenkou' && data.respectSystem && newStage >= 2) {
    ...
    if ((G.reputation || 0) < 30 && Math.random() < 0.3) {
      ...
      events.push({ title: 'Kaenkou — Disrespect Felt', body: 'Kaenkou sensed your village\'s diminished standing and withdrew cooperation this month. Sync progress was reversed slightly. The Four-Tails will not partner with a village it cannot respect.', type: 'warn' })
    }
  }
...
export function applyBeastPairEffects(G) {
  ...
  // Niryuu + Hanaku: both jinchuriki get morale
